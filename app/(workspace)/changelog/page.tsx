...
export const metadata: Metadata = { title: 'Changelog | Oxiom Invoice Processing', description: 'Complete changelog for Oxiom Invoice Processing. Version history, feature additions, improvements.' };
...
const releases = [
  {
    ...
    date: '2026-07-25',
    changes: [
      'Launched enterprise content hubs for support, legal, security, compliance, solutions, and documentation.',
      'Published structured messaging around AP automation, workflow controls, and ERP integration.',
  ...
  },
  {
    ...
    date: '2026-06-30',
    changes: [
      'Improved invoice queue performance and dashboard summary accuracy.',
      'Refined workflow state handling for approval, verification, and payment-ready statuses.',
  ...
  },
  {
    ...
    date: '2026-05-18',
    changes: [
      'Added broader approval workflow support and invoice history visibility.',
      'Expanded invoice detail views with richer operational metadata.',
      'Introduced payment queue workflows for downstream AP readiness.',
    ],
  },
  {
    version: 'v0.8.5',
