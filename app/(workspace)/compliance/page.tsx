...
export const metadata: Metadata = { title: 'Compliance | Oxiom Invoice Processing', description: 'Regulatory compliance for AP automation. GDPR, CCPA, SOX, and audit trail capabilities.' };
...
const sections = [
  ...
  ['SOX support', 'Oxiom preserves user actions, status changes, approval decisions, and exception handling history so finance teams can support internal controls, testing, and external audit requests more efficiently.'],
  ['Financial compliance', 'Invoice workflows can be configured to reflect segregation of duties, approval thresholds, validation rules, and documentation requirements that support broader finance governance standards.'],
