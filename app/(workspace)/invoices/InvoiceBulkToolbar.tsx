...
const placeholderMessage = 'Bulk actions are placeholders in Module 2. No backend mutation was performed and nothing was saved.';
    ...
    <section aria-label="Bulk invoice actions" className="rounded-xl border border-blue-200 bg-blue-50 p-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-blue-800">Bulk actions are not connected to a backend in this module.</p>
        </div>
        <div className="flex flex-col gap-2 sm:flex-row">
          <button type="button" onClick={() => onMessage(placeholderMessage)} className="rounded-lg border border-blue-200 bg-white px-4 py-2 text-sm font-semibold text-blue-700 hover:border-blue-300">
            Mark reviewed
          </button>
          <button type="button" onClick={() => onMessage(placeholderMessage)} className="rounded-lg border border-blue-200 bg-white px-4 py-2 text-sm font-semibold text-blue-700 hover:border-blue-300">
            Assign owner
