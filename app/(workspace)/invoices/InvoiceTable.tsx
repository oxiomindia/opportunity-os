              ...
              <tr key={invoice.id} className="hover:bg-slate-50">
                ...
                <td className="px-4 py-4 align-top">
                  <div className="relative flex items-center gap-2">
                    ...
                    <Link href={`/extraction/${invoice.id}`} className="rounded-md border border-blue-200 px-3 py-1.5 text-sm font-semibold text-blue-700 hover:border-blue-300">
                      Extract
                    </Link>
                    ...
                    {openMenuInvoiceId === invoice.id && (
                      <div className="absolute right-0 top-9 z-20 w-48 rounded-lg border border-slate-200 bg-white p-1 shadow-lg" role="menu" aria-label={`Actions for invoice ${invoice.invoiceNumber}`}>
                        ...
                        <Link href={`/extraction/${invoice.id}`} role="menuitem" className="block w-full rounded-md px-3 py-2 text-left text-sm text-slate-700 hover:bg-slate-50">Open extraction</Link>
