...
import { products, getPublicProducts, getProductById, getCategoryById } from '../../../lib/products/catalog';
import { getProductDisplayName, getProductBadge, getStatusTone, getAvailabilityMessage } from '../../../lib/products/types';
...
export default async function ProductDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const otherProducts = getPublicProducts().filter((entry) => entry.id !== product.id).slice(0, 3);
    ...
    <div className="min-h-screen bg-white text-slate-950">
      ...
      <main>
        ...
        <DemoCta
          ...
          description="Book a focused walkthrough with our team."
          href={product.bookDemoHref}
          label="Book Demo"
        />
      </main>
