...
export default function LoginForm({ demoEnabled }: Readonly<{ demoEnabled: boolean }>) {
  ...
  return (
    <form action={action} className="mt-8 space-y-5">
      ...
      <button disabled={pending} className="h-11 w-full rounded-lg bg-blue-600 font-semibold text-white hover:bg-blue-700 disabled:cursor-wait disabled:opacity-60">
