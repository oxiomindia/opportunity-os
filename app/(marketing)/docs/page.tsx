...
const sections = [
  ...
  {
    title: 'User Guides',
    description: 'Learn how billing and finance teams use Oxiom day to day.',
    items: [
  ...
  },
  {
    ...
    description: 'Review API usage, accounting integration alignment, and trust documentation before integration work begins.',
    items: [
